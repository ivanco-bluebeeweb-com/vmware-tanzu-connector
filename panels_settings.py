"""Settings panel for VMware Tanzu Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__vmware_tanzu_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=vmware_tanzu_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_vmware_tanzu"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("VMware Tanzu Settings & Accounts", level=2),
